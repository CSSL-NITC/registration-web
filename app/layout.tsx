...
export const metadata: Metadata = {
  title:
    "Nation IT Conference 2025 | Sri Lanka's Premier Technology Conference",
  description:
  ...
  keywords:
    "technology conference, IT conference, Sri Lanka, CSSL, innovation, networking, tech summit",
  authors: [{ name: "Computer Society of Sri Lanka" }],
  openGraph: {
    title: "Nation IT Conference 2025",
    description:
      "Sri Lanka's premier technology conference at Shangri-La Hotel, Colombo",
    type: "website",
    locale: "en_US",
  },
  generator: "v0.dev",
